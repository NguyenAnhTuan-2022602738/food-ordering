      ...
      <div className="min-h-screen bg-gray-50 flex flex-col">
        <div className="flex-1 flex flex-col items-center justify-center p-4">
          <div className="bg-white p-12 rounded-3xl shadow-xl text-center max-w-md w-full border border-gray-100">
            ...
            <p className="text-gray-500 mb-8">Có vẻ như bạn chưa thêm món ăn nào.</p>
            <Link 
              to="/menu" 
            ...
            >
              Bắt đầu đặt món <ArrowRight size={20} />
            </Link>
          </div>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 pt-32 pb-20">
        <div className="flex items-center gap-4 mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Giỏ hàng <span className="text-gray-400 text-lg font-normal">({cart.length} món)</span></h1>
        </div>
