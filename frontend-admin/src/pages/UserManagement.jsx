  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-blue-50 border border-blue-100 rounded-xl p-4 flex items-start gap-3">
        ...
        <div>
          <h3 className="font-semibold text-blue-800 text-sm">Feature Note</h3>
          <p className="text-blue-600 text-sm mt-1">
            User management features are currently read-only. Full administration capabilities (edit roles, block users) will be available in future updates.
          </p>
        </div>
      </div>
    </div>
